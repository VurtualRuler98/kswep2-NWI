...
if (CLIENT) then
	SWEP.PrintName = "DOI Panzerfaust"
	SWEP.Author = "vurtual"
	SWEP.Slot = 4
	SWEP.SlotPos = 0
end
...
SWEP.Primary.Rocketsound = Sound("Weapon_at4.single")
...
SWEP.IronSightsPos = Vector(-2.95, 2, 2.74)
SWEP.IronSightsAng = Vector(-6,0,7.5)
...
SWEP.RocketClass="sent_kgrend_panzerfaust"
SWEP.RocketForce=40000
...
function SWEP:DiscoverModelAnims()
	...
	self:SetAnim("RunAnimEmpty",self:DiscoverAnim("ACT_VM_SPRINT"))
end
