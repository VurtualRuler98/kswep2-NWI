...
if (CLIENT) then
	SWEP.PrintName = "ins2 'M2 Carbine'"
	SWEP.Author = "vurtual"
	SWEP.Slot = 2
	SWEP.SlotPos = 0
end
...
SWEP.Spawnable = true
SWEP.DrawOnce=false
SWEP.DefaultZero=150
SWEP.DefaultBattlesightZero=0
SWEP.DefaultMinZero=150
SWEP.DefaultMaxZero=300
SWEP.DefaultZeroStep=50
...
SWEP.MergeAttachments = {
	magazine="models/weapons/upgrades/a_magazine_m1a1_30.mdl"
 }
