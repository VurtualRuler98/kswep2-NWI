...
SWEP.OpenBolt=true
SWEP.DefaultZero=92
SWEP.AltIronsZero=92*3
SWEP.DefaultMinZero=92
SWEP.DefaultMaxZero=92*12
...
SWEP.IronSightsPos = Vector(-2.465, -2, 1.1)+Vector(1,0,-0.4)
SWEP.IronSightsAng = Vector(-0.2, 0, 0)
SWEP.AltIrons=true
SWEP.AltIronOffsetPos = Vector()-Vector(1,0,-0.4)
