...
SWEP.Primary.SoundSup = Sound("Weapon_AK47.SingleSilenced")
...
SWEP.IronSightsPos = Vector(-2.295, -2, 0.057)
SWEP.IronSightsAng = Vector(1.3, 0, 0)
SWEP.ZeroVelocity=2346
SWEP.ScopeOffsetPos=Vector(-0.015,0,-0.784)
SWEP.ScopeOffsetAng=Vector(-1.3,0,0)
